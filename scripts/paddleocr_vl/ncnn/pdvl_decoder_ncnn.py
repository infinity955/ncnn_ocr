...
def test_inference():
    torch.manual_seed(0)
    in0 = torch.rand(1, 16, 1024, dtype=torch.float)
    ...
    with ncnn.Net() as net:
        net.load_param("D:/MySystem/share/SummerNcnn/pnnx/ncnn_ocr/scripts/paddleocr_vl/ncnn/pdvl_decoder.ncnn.param")
        net.load_model("D:/MySystem/share/SummerNcnn/pnnx/ncnn_ocr/scripts/paddleocr_vl/ncnn/pdvl_decoder.ncnn.bin")
