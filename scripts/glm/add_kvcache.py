"""Add KV-cache support to the GLM-OCR ncnn decoder param.
...
Usage: .venv-glm/Scripts/python.exe scripts/glm/add_kvcache.py [path_to_glm_decoder.ncnn.param]
...
DEF = os.path.join(HERE, "ncnn", "glm_decoder.ncnn.param")
HEAD_DIM = 128
